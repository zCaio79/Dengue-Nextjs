...
export default function RegisterForm() {
    ...
    return (
        <form onSubmit={handleSubmitLogin} className="flex flex-col gap-6 h-fit w-screen p-7 font-robotoMono text-red-500 font-semibold bg-white rounded-lg md:w-fit md:h-fit">
