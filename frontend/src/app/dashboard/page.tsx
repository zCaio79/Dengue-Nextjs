...
import { ArrowDown, ArrowLeft, Search, User2Icon } from "lucide-react";
...
export default function Dashboard() {
    ...
    return (
        <div className="flex w-full flex-col p-4 min-h-screen bg-gradient-to-r from-red-500 via-orange-500 to-red-500 lg:p-6 lg:h-screen">
            ...
            <header className="flex flex-col w-full mb-4 gap-3 px-4 py-4 items-center justify-between bg-white rounded-lg lg:mb-6 lg:flex-row lg:gap-6 lg:px-6">
                ...
                <nav className="flex h-fit flex-col-reverse w-full gap-4 lg:w-1/2 md:flex-row md:itens-center lg:h-12">
                    
                    <DateFilterBtn/>

                    <div className="relative flex w-full font-robotoMono font-medium text-sm">

                        <input type="text" className="flex w-full py-2 px-4 pr-8 border-2 border-dashed border-red-500 rounded-xl outline-none" placeholder="Procurar localização" />
            ...
            <main className="flex flex-col-reverse gap-2 mb-4 w-full h-full justify-between overflow-hidden lg:flex-row lg:gap-8 h-sm:flex-col">
