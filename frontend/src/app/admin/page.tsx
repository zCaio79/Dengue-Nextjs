...
export default function Admin() {
    const users: Users = [
        ...
        { id: 3, name: "Carla Mendes", email: "carla@example.com", permission: 2, active: true },
        { id: 4, name: "Daniel Rocha", email: "daniel@example.com", permission: 1, active: false },
        { id: 5, name: "Eduarda Lima", email: "eduarda@example.com", permission: 1, active: true },
        { id: 6, name: "Alice Silva", email: "alice@example.com", permission: 2, active: false },
        ...
        { id: 9, name: "Daniel Rocha", email: "daniel@example.com", permission: 1, active: true },
        ...
        { id: 12, name: "Bruno Souza", email: "bruno@example.com", permission: 2, active: false },
        ...
        { id: 15, name: "Eduarda Lima", email: "eduarda@example.com", permission: 2, active: true }


    ];

    return (
        <div className="text-white p-0 gap-4 flex min-h-screen flex-col w-full justify-center
         items-center bg-zinc-900 md:h-screen md:px-6 md:pt-6 md:pb-3">
            <main className="flex w-full h-screen justify-center p-0 md:p-8 md:h-full">
